...
public class TinyDB {
    ...
    public ArrayList<SubcatItemModel> getListObject(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<SubcatItemModel> objects = new ArrayList<SubcatItemModel>();

        for (String jObjString : objStrings) {
            SubcatItemModel value = (SubcatItemModel) gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, List<SubcatItemModel> list) {
        checkForNullKey(key);
        Gson gson = new Gson();
